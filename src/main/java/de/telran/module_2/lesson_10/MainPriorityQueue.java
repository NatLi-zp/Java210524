...
public class MainPriorityQueue {
    public static void main(String[] args) {
        PriorityQueue<String> queue = new PriorityQueue<>(); // стандартная сортировка String
        queue.offer("Маша");
        queue.offer("Петя");
        queue.offer("Паша");
        queue.offer("Миша");
        ...
        while (!queue.isEmpty()) {
            System.out.println("Извлечено  poll = " + queue.poll());

            // смена приоритета
            Comparator<String> comparatorReversed = new Comparator<String>() {
                @Override
                public int compare(String o1, String o2) {
                    return o2.compareTo(o1); // аналог реверса
                }
            };
