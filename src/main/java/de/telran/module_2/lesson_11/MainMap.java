...
//        System.out.println(listValues); // перечень value
        ...
        //Удаление объектов
        System.out.println("Удаление объектов key = 3 ->" + map2.remove(3));
        System.out.println(map2);

        System.out.println("Удаление объектов key = 2 и value->" + map2.remove(2, "Наша новая 2"));
        System.out.println(map2);
        ...
        System.out.println("поиск key=11(нет) ->" + map2.getOrDefault(11, "По умолчанию"));
